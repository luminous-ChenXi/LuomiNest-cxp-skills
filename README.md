...
| 仓库 | 作用 |
|------|------|
| **LuomiNest-cxp-skills**（本仓库） | 技能集合，所有技能以子目录形式存放 |
| LuomiNest-cxp-registry | 索引注册表，聚合所有插件/技能元数据到 `index.json` |
...
详细字段说明见 LuomiNest 主仓库 [docs/development/plugin-system.md](https://github.com/luminous-ChenXi/LuomiNest/blob/main/docs/development/plugin-system.md)。
...
MIT — 见 [LICENSE](./LICENSE)（如有）或 LuomiNest 主仓库 LICENSE。
